...
def managed_intake_entry() -> dict[str, Any]:
    return {
        ...
        "env": {
            ...
            "INTERNAL_INTAKE_CONTEXT_RECEIPT_TTL_MINUTES": "${INTERNAL_INTAKE_CONTEXT_RECEIPT_TTL_MINUTES}",
            "INTERNAL_INTAKE_CONTEXT_SIGNING_KEY": "${INTERNAL_INTAKE_CONTEXT_SIGNING_KEY}",
            "INTERNAL_INTAKE_DEVICE_CREDENTIALS_JSON": "${INTERNAL_INTAKE_DEVICE_CREDENTIALS_JSON}",
            "INTERNAL_INTAKE_TELEGRAM_BOT_USERNAME": "${INTERNAL_INTAKE_TELEGRAM_BOT_USERNAME}",
            "ODOO_MCP_URL": "${ODOO_MCP_URL}",
            "HOME": "/data",
